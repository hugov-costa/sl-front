...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-[var(--radius)] px-3 py-1.5 text-sm font-semibold transition-all outline-none hover:bg-muted/60 focus:bg-primary/10 focus-visible:ring-2 focus-visible:ring-ring/50 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-muted/50 data-popup-open:hover:bg-muted/60 data-open:bg-muted/50 data-open:hover:bg-muted/60 data-open:focus:bg-muted/60",
);
